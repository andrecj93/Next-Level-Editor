...
- **5,101 Unit Checks** - Across 398 files after the library build, with enforced coverage thresholds (70% lines/functions/statements, 65% branches). Bundle-dependent checks also run in the package build gate.
...
| --- | --- | --- | --- |
| **Core (ES)** | 967.1 KB | **235.6 KB** | On import |
...
| **UMD** | 1,706.3 KB | 509.5 KB | On import (no splitting) |
