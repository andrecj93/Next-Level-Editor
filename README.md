...
- **5,166 Unit Checks** - Across 403 files after the library build, with enforced coverage thresholds (70% lines/functions/statements, 65% branches). Bundle-dependent checks also run in the package build gate.
...
| --- | --- | --- | --- |
| **Core (ES)** | 975.2 KB | **237.9 KB** | On import |
| **CSS** | 262.0 KB | **42.0 KB** | On import |
...
| **UMD** | 1712.3 KB | 511.7 KB | On import (no splitting) |

So a page that never opens a code block, never picks a colour and never
exports pays **279.9 KB gzipped** for the library's JS + CSS. Vue is an external
