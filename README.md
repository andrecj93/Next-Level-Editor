...
**It is tested like something you'd put in production.** 4,788 unit checks
...
- **4,788 Unit Checks** - Across 372 files, with enforced coverage thresholds (70% lines/functions/statements, 65% branches). Bundle-dependent checks also run after the library build.
