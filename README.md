...
| --- | --- | --- | --- |
| **Core (ES)** | 1,309.0 KB | **317.7 KB** | On import |
...
| **UMD** | 3,345.8 KB | 1,074.7 KB | On import (no splitting) |

So a page that never opens a code block, never picks a colour and never
exports pays **360.4 KB gzipped** for the library's JS + CSS. Vue is an external
...
Verified on 2026-09-23: 4,789 unit tests passed; 85.03% line coverage.
...
#### Unit Tests (4,789 tests across 371 files, with Vitest)
...
- **ES Module** - `dist/next-level-editor.mjs` (core 1,309.0 KB, 317.7 KB gzipped)
...
- **UMD** - `dist/next-level-editor.umd.js` (3,345.8 KB, 1,074.7 KB gzipped)
