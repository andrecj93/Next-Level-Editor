...
| --- | --- | --- | --- |
| **Core (ES)** | 964.9 KB | **235.1 KB** | On import |
...
| **UMD** | 1,704.6 KB | 509.2 KB | On import (no splitting) |

So a page that never opens a code block, never picks a colour and never
exports pays **277.1 KB gzipped** for the library's JS + CSS. Vue is an external
