...
- **5,141 Unit Checks** - Across 400 files after the library build, with enforced coverage thresholds (70% lines/functions/statements, 65% branches). Bundle-dependent checks also run in the package build gate.
...
| --- | --- | --- | --- |
| **Core (ES)** | 968.0 KB | **235.5 KB** | On import |
| **CSS** | 261.4 KB | **41.9 KB** | On import |
...
| **UMD** | 1,708.1 KB | 510.1 KB | On import (no splitting) |

So a page that never opens a code block, never picks a colour and never
exports pays **277.4 KB gzipped** for the library's JS + CSS. Vue is an external
