...
- **5,042 Unit Checks** - Across 394 files after the library build, with enforced coverage thresholds (70% lines/functions/statements, 65% branches). Bundle-dependent checks also run in the package build gate.
...
| --- | --- | --- | --- |
| **Core (ES)** | 961.8 KB | **234.0 KB** | On import |
...
| **UMD** | 1,702.3 KB | 508.3 KB | On import (no splitting) |

So a page that never opens a code block, never picks a colour and never
exports pays **275.9 KB gzipped** for the library's JS + CSS. Vue is an external
