...
- **5,082 Unit Checks** - Across 398 files after the library build, with enforced coverage thresholds (70% lines/functions/statements, 65% branches). Bundle-dependent checks also run in the package build gate.
...
| --- | --- | --- | --- |
| **Core (ES)** | 964.5 KB | **234.9 KB** | On import |
...
| **UMD** | 1,704.4 KB | 509.1 KB | On import (no splitting) |

So a page that never opens a code block, never picks a colour and never
exports pays **276.9 KB gzipped** for the library's JS + CSS. Vue is an external
