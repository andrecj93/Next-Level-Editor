...
- **5,155 Unit Checks** - Across 401 files after the library build, with enforced coverage thresholds (70% lines/functions/statements, 65% branches). Bundle-dependent checks also run in the package build gate.
...
| --- | --- | --- | --- |
| **Core (ES)** | 971.8 KB | **236.2 KB** | On import |
| **CSS** | 261.6 KB | **42.0 KB** | On import |
...
| **UMD** | 1,710.9 KB | 510.7 KB | On import (no splitting) |

So a page that never opens a code block, never picks a colour and never
exports pays **278.2 KB gzipped** for the library's JS + CSS. Vue is an external
