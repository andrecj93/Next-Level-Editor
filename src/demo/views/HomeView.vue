...
The toolbar earns its keep by leaving. Start writing and the chrome folds
        ...
        <div class="demos chrome-demos">
          <LiveDemo
            ...
            desc="One prop — adaptive-chrome=&quot;letterbox&quot; — and the masthead dissolves into an ambient band while you write, leaving nothing between you and the page. It never interrupts a thought to come back. (The default toolbar stays rock-solid and static.)"
