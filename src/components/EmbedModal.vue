...
const videoUrl = ref('')
// The preview keeps the responsive 16:9 wrapper (nothing else sizes it here);
// what gets INSERTED is the bare player, because the editor's embed container
// is already the box. #R23-62
const previewHtml = ref('')
const playerHtml = ref('')
...
const handleUrlChange = () => {
  ...
  if (embedHtml) {
    ...
    playerHtml.value = getVideoPlayerHtml(videoUrl.value) ?? ''
  } else {
