...
describe('ColorPicker', () => {
  ...
  beforeEach(() => {
    ...
    vi.mock('@cyhnkckali/vue3-color-picker', () => ({
      Vue3ColorPicker: {
        ...
        props: ['modelValue', 'mode', 'type', 'theme', 'showColorList', 'showEyeDrop', 'showAlpha', 'showInputMenu', 'showInputSet', 'showPickerMode', 'showButtons']
      }
    }))
  ...
  describe('Color Changes', () => {
    it('should emit update:modelValue when internal color changes', async () => {
      wrapper = mount(ColorPicker, {
        props: {
          modelValue: '#000000'
        }
  ...
  describe('Theme Detection', () => {
    ...
    it('should detect dark theme when editor has dark class', async () => {
