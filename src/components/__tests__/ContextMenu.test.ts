...
describe("ContextMenu", () => {
  ...
  it("renders when show is true", () => {
    ...
    // Teleported chrome must carry the editor-owned marker: the print
    // stylesheet hides .nle-chrome instead of the generic .context-menu (which
    // would blank a HOST page's own element of that name). #r16-9
    expect(menu!.classList.contains("nle-chrome")).toBe(true);
  });
