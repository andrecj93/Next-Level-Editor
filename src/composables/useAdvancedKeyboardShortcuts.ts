  ...
  const registerShortcuts = () => {
    const shortcuts: Shortcut[] = [
      ...
      },
      {
        ...
        // Disabled by default: Ctrl/Cmd+Shift+I is the browser DevTools
        // shortcut. Leaving it enabled swallowed DevTools while editing.
        // Customizable, so a host/user can bind a non-conflicting combo.
        enabled: false,
        customizable: true,
      },
      {
        ...
        // Disabled by default: Ctrl/Cmd+Shift+T is "reopen closed tab".
        enabled: false,
        customizable: true,
      },
      {
