...
describe('useSlashCommands', () => {
  ...
  describe('Command Options', () => {
    ...
    it('should have paragraph command', () => {
      ...
      const pCommand = commandOptions.find(cmd => cmd.id === 'slash-paragraph')
    ...
    it('should have italic command', () => {
      ...
      const italicCommand = commandOptions.find(cmd => cmd.id === 'slash-italic')
    ...
    it('should have bullet list command', () => {
      ...
      const bulletCommand = commandOptions.find(cmd => cmd.id === 'slash-bullet')
    ...
    it('should have numbered list command', () => {
      ...
      const numberedCommand = commandOptions.find(cmd => cmd.id === 'slash-numbered')
    ...
    it('should have quote command', () => {
      ...
      const quoteCommand = commandOptions.find(cmd => cmd.id === 'slash-quote')
    ...
    it('should have image command', () => {
      ...
      const imageCommand = commandOptions.find(cmd => cmd.id === 'slash-image')
    ...
    it('should have table command', () => {
      ...
      const tableCommand = commandOptions.find(cmd => cmd.id === 'slash-table')
    ...
    it('should have divider command', () => {
      ...
      const dividerCommand = commandOptions.find(cmd => cmd.id === 'slash-divider')
  ...
  describe('Command Menu Operations', () => {
    ...
    it('should close command menu', () => {
      const { openCommandMenu, closeCommandMenu, showCommandMenu } = useSlashCommands(options)
    ...
    it('should set command menu position when opened', async () => {
      const { openCommandMenu, commandMenuPosition } = useSlashCommands(options)
  ...
  describe('Handle Command Option', () => {
    it('should execute command action and close menu', () => {
      const { handleCommandOption, commandOptions, showCommandMenu, openCommandMenu } = useSlashCommands(options)
  ...
  describe('Event Handlers', () => {
    it('should close menu on escape key', () => {
      const { openCommandMenu, handleEscape, showCommandMenu } = useSlashCommands(options)
    ...
    it('should close menu on document click outside', () => {
      const { openCommandMenu, handleDocumentClick, showCommandMenu } = useSlashCommands(options)
    ...
    it('should not close menu on click inside command menu', () => {
      ...
      const event = new MouseEvent('click')
      Object.defineProperty(event, 'target', { value: commandMenuElement, writable: false })
      handleDocumentClick(event)
