...
describe('useFormattingHandlers', () => {
  let mockPerformWithSelection: (action: (root: HTMLElement) => void, afterAction?: () => void) => void
  ...
  beforeEach(() => {
    vi.clearAllMocks()
    mockPerformWithSelection = vi.fn((action: (root: HTMLElement) => void, afterAction?: () => void) => {
  ...
  describe('Edge Cases', () => {
    it('should handle rapid formatting operations', () => {
      const { handleInlineAction, handleBlockAction, handleListAction } = useFormattingHandlers({
        performWithSelection: mockPerformWithSelection,
        captureSnapshot: mockCaptureSnapshot,
        handleTextColorBase: mockHandleTextColorBase,
        handleBackgroundColorBase: mockHandleBackgroundColorBase,
