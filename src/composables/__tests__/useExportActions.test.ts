...
describe('useExportActions', () => {
  ...
  describe('exportHtml', () => {
    it('should export content as HTML', () => {
      ...
      expect(exportUtils.exportAsHtml).toHaveBeenCalledWith('<p>Test content</p>')
      expect(mockShowToast).toHaveBeenCalledWith('✓ Exported as HTML successfully!')
    })
    ...
    it('should handle export errors', () => {
      ...
      expect(mockShowToast).toHaveBeenCalledWith('✗ Failed to export as HTML', 'error')
    })

    it('should be accessible via handleExportHtml alias', () => {
      vi.mocked(exportUtils.exportAsHtml).mockClear().mockImplementation(() => {})
  ...
  describe('exportMarkdown', () => {
    it('should export content as Markdown', () => {
      ...
      expect(exportUtils.exportAsMarkdown).toHaveBeenCalledWith('<p>Test content</p>')
      expect(mockShowToast).toHaveBeenCalledWith('✓ Exported as Markdown successfully!')
    })
    ...
    it('should handle export errors', () => {
      ...
      expect(mockShowToast).toHaveBeenCalledWith('✗ Failed to export as Markdown', 'error')
    })

    it('should be accessible via handleExportMarkdown alias', () => {
      vi.mocked(exportUtils.exportAsMarkdown).mockClear().mockImplementation(() => {})
  ...
  describe('exportPdf', () => {
    it('should export content as PDF', async () => {
      ...
      expect(mockShowToast).toHaveBeenCalledWith('✓ Exported as PDF successfully!')
    })
    ...
    it('should handle export errors', async () => {
      vi.mocked(exportUtils.exportAsPdf).mockRejectedValue(new Error('PDF generation failed'))
      ...
      expect(mockShowToast).toHaveBeenCalledWith('✗ Failed to export as PDF', 'error')
    })

    it('should be accessible via handleExportPdf alias', async () => {
      vi.mocked(exportUtils.exportAsPdf).mockClear().mockResolvedValue(undefined)
  ...
  describe('exportWord', () => {
    it('should export content as Word document', async () => {
      ...
      expect(exportUtils.exportAsWord).toHaveBeenCalledWith('<p>Test content</p>')
      expect(mockShowToast).toHaveBeenCalledWith('✓ Exported as Word document successfully!')
    })
    ...
    it('should handle export errors', async () => {
      vi.mocked(exportUtils.exportAsWord).mockRejectedValue(new Error('Word generation failed'))
      ...
      expect(mockShowToast).toHaveBeenCalledWith('✗ Failed to export as Word', 'error')
    })

    it('should be accessible via handleExportWord alias', async () => {
      vi.mocked(exportUtils.exportAsWord).mockClear().mockResolvedValue(undefined)
  ...
  describe('formatHtmlCode', () => {
    it('should format HTML code in code editor', () => {
      ...
      vi.mocked(exportUtils.formatHtml).mockReturnValue('<div>\n  <p>Test</p>\n</div>')
      ...
      expect(exportUtils.formatHtml).toHaveBeenCalledWith('  <div>   <p>Test</p>   </div>  ')
      expect(mockUpdateCodeContent).toHaveBeenCalledWith('<div>\n  <p>Test</p>\n</div>')
      expect(mockShowToast).toHaveBeenCalledWith('✓ HTML formatted successfully!')
    })
  ...
  describe('handleFormatHtml', () => {
    it('should format HTML content in editor', () => {
      ...
      vi.mocked(exportUtils.formatHtml).mockReturnValue('<p>\n  Test content\n</p>')
      ...
      expect(exportUtils.formatHtml).toHaveBeenCalledWith('<p>Test content</p>')
    ...
    it('should handle complex HTML structures', () => {
      editorElement.innerHTML = '<div><ul><li>Item 1</li><li>Item 2</li></ul></div>'
      ...
      expect(htmlContent.value).toBe('<div>\n  <ul>\n    <li>Item 1</li>\n    <li>Item 2</li>\n  </ul>\n</div>')
      expect(mockCaptureSnapshot).toHaveBeenCalledTimes(1)
    })
  })
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle all exports sequentially', async () => {
      ...
      const { exportHtml, exportMarkdown, exportPdf, exportWord } = useExportActions({
        editorContent: ref(editorElement),
        htmlContent: ref(''),
        codeContent: ref(''),
        showToast: mockShowToast,
      ...
      expect(mockShowToast).toHaveBeenNthCalledWith(1, '✓ Exported as HTML successfully!')
      expect(mockShowToast).toHaveBeenNthCalledWith(2, '✓ Exported as Markdown successfully!')
      expect(mockShowToast).toHaveBeenNthCalledWith(3, '✓ Exported as PDF successfully!')
      expect(mockShowToast).toHaveBeenNthCalledWith(4, '✓ Exported as Word document successfully!')
    })
  })
})
