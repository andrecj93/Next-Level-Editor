...
describe("useContextMenu", () => {
  ...
  describe("Context Menu Items", () => {
    ...
    it("should include cut, copy, paste items", () => {
      ...
      const itemIds = contextMenuItems.value
    ...
    it("should disable items when no text is selected", () => {
      ...
      const boldItem = contextMenuItems.value.find(
        (item) => item.id === "bold"
      );
  ...
  describe("closeContextMenu", () => {
    it("should hide context menu", () => {
      const { handleContextMenu, closeContextMenu, showContextMenu } =
        useContextMenu({
          editorContent,
          handleInlineAction,
          insertLink,
  ...
  describe("Menu Item Actions", () => {
    ...
    it("should call handleInlineAction for italic", () => {
      ...
      const italicItem = contextMenuItems.value.find(
        (item) => item.id === "italic"
      );
      italicItem?.onClick?.();
    ...
    it("should call insertLink for link item", () => {
      ...
      const linkItem = contextMenuItems.value.find(
        (item) => item.id === "link"
      );
      linkItem?.onClick?.();
    ...
    it("should call insertImage for image item", () => {
      ...
      const imageItem = contextMenuItems.value.find(
        (item) => item.id === "image"
      );
      imageItem?.onClick?.();
