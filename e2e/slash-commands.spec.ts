...
test.describe("Slash Commands", () => {
  ...
  test("should not fragment list items when converting to heading", async ({ page }) => {
  ...
  test("should unnest list item when converting to paragraph", async ({ page }) => {
    const editor = page.locator(".editor-content");
    await editor.click();
  ...
  test("should show toast notification after slash command", async ({ page }) => {
    const editor = page.locator(".editor-content");
    await editor.click();
