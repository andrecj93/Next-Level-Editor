...
test.describe("Next Level Editor - UX Improvements", () => {
  ...
  test.describe("Slash Commands", () => {
    test('should not insert "/" character when opening slash command menu', async ({
      page,
    }) => {
    ...
    test('should insert list without "/" artifact on undo', async ({
      page,
    }) => {
      const editor = page.locator(".editor-content");
      await editor.click();
  ...
  test.describe("Auto-Save Indicator", () => {
    ...
    test.skip("should show saving indicator when content changes", async ({
      page,
    }) => {
      const editor = page.locator(".editor-content");
      await editor.click();
  ...
  test.describe("Export Buttons", () => {
    ...
    test("export buttons should have descriptive tooltips", async ({
      page,
    }) => {
      const htmlButton = page.locator('button:has-text("HTML")');
  ...
  test.describe("Image Upload Modal", () => {
    test("should show helpful hint when no image provided", async ({
      page,
    }) => {
      // Open Insert menu
    ...
    test("should enable Insert button when URL is provided", async ({
      page,
    }) => {
      // Open Insert menu
      await page.click('button:has-text("Insert")');
  ...
  test.describe("Redo Shortcut", () => {
    ...
    test("should support Ctrl+Shift+Z for redo (existing shortcut)", async ({
      page,
    }) => {
      const editor = page.locator(".editor-content");
      await editor.click();
  ...
  test.describe("Table Insertion", () => {
    test("should show notification when table is inserted", async ({
      page,
    }) => {
      const editor = page.locator(".editor-content");
      await editor.click();
