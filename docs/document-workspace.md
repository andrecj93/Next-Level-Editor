...
| F11 / #143 | Stable block/chapter move, duplicate/delete, reference renumbering, one undo | Duplicating blocks with attached notes/citations/comments is refused until references are resolved; pending review blocks cannot be rearranged. |
