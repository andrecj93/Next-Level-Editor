...
The complete feature build measured on 2026-09-23 with Node 24.14.1 on Windows has a 343.23 KiB gzip ES core and 44.13 KiB gzip CSS (387.36 KiB combined). The base writing branch reports 262.7 KiB combined. These totals include all document features, so they do not isolate the collaboration adapter's cost. The unsplit UMD bundle is 1,106.47 KiB gzip. Prefer the ES build for deferred heavy features.
