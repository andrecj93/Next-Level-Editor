...
The complete feature build measured on 2026-09-23 with Node 24.14.1 on Windows has a 342.59 KiB gzip ES core and 44.08 KiB gzip CSS (386.67 KiB combined). The base writing branch reports 262.7 KiB combined. These totals include all document features, so they do not isolate the collaboration adapter's cost. The unsplit UMD bundle is 1,106.12 KiB gzip. Prefer the ES build for deferred heavy features.
